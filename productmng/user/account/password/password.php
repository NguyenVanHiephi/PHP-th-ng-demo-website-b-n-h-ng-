  ...
  <div class="YN9KVd">
    <div class="TYsRUL">
      <div class="NAtk5x"><button class="_Jufph"><svg viewBox="0 0 22 17" class="MyzrtM">
        ...
        <div class="Muwqtl caVZu7">
          <div class="QKYgq_">Nhập mật khẩu </div>
        </div>
      </div>
    </div>
    <div class="p7oxk2 Rlj6l5">
      <div>
        ...
        <input type="hidden" class="form-control" name="action"  value="confirm_pass">
          <div>
            <div></div>
            <div class="_4TWkAX">
              <div class="q18aRr"><input class="Btdmxp" type="password" placeholder="Nhập mật khẩu hiện tại để xác minh" autocomplete="current-password" name="password" maxlength="16" aria-invalid="false" value=""></div>
              <div id="authentication-input-error_bd205986-cc15-40a9-a9ca-1cb98ee16df6" class="Se7P7J" aria-live="polite"></div>
            </div><button class="DYKctS hqfBzL SYqMlu NBaRN4 CEiA6B ukVXpA" >XÁC NHẬN</button>
          </div>
        </form>
      </div>
    </div>
